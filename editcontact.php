    ...
    <div class="container border" style="width: 200% ;">
        ...
        <table class="table table-striped table-hover " style="position: relative;">
            ...
            <tbody>
                <tr>
                    ...
                    <td><a href="updatecontact.php?cid=<?=$contact_row['cid'];?>" class="btn-sm btn-primary"
                            type="button">Edit</a>&nbsp;<a
                            href="deletecontact.php?cid=<?=$contact_row['cid'];?>"
                             type="button" class="btn-sm btn-danger">Delete</a>
                    </td>
                </tr>
            </tbody>
            <form action="<?= htmlentities($_SERVER['PHP_SELF']);?>" method="POST">
                <input type="hidden" name="cid" value=";<?= $contact_row['cid'];?>">
            </form>
            <?php 
        ...
        <nav aria-label="Page navigation example">
            ...
            if($page > 1){
                ...
                <a class="page-link" href="editcontact.php?page='.($page - 1).'" aria-label="Previous">
            ...
            for($i=1;$i<=$total_pages;$i++){
                ...
                echo '<li class="page-item '.$active.'"><a class="page-link" href="editcontact.php?page='.$i.'">'.$i.'</a></li>';
            }
            if($total_pages > $page){
                echo ' <li class="page-item">
                <a class="page-link" href="editcontact.php?page='.($page + 1).'" aria-label="Next">
