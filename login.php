        ...
        ">
            ...
            if($_SERVER['REQUEST_METHOD']=="POST"){
                ...
                if(mysqli_num_rows($user_check)>0){
                  while($pass_row = mysqli_fetch_assoc($user_check)){
            ...
            ?>
                            ...
                            <div class="form-outline mb-4">
                                <input type="password" placeholder="Password" id="form3Example4" class="form-control"
                                   name="psw"/>
                                <label class="form-label" for="form3Example4">Password</label><span class="err">*</span>
                            </div>
                            ...
                            If Not a User??<a href="signup.php">Sign up here</a>
